...
public class FeeandPaymentSteps {
	...
	@And("I select {string} and {string} in exam fee plan")
	public void iSelectExamFeePlan(String feepalntype, String currency) throws Exception {
		new FeeandPaymentPages().iSelectExamFeePlan(feepalntype, currency);
	}
	
	@And("I select the created exam fee plan")
	public void ISelectexamFeePlan() throws Exception {
		new FeeandPaymentPages().ISelectexamFeePlan();

	}
	@And("I select exam fee plan rule {string} and {string} and {string} and {string}")
	public void iSelectExamFeeplanStatusStageDueDays(String status, String stage, String duedays, String descrption)
			throws Exception {
		new FeeandPaymentPages().iSelectExamFeeplanStatusStageDueDays(status, stage, duedays, descrption);
	}
	
	@And("I select the created exam fee plan for approve")
	public void iSelectExamFeePlanforApprove() throws Exception {
		new FeeandPaymentPages().iSelectExamFeePlanforApprove();

	}
	
	@And("I close feee details tab and choose manage feeplan tab")
	public void iClodeFeeDetailsTabandChooseManageFeeplanTab() throws Exception {
      new FeeandPaymentPages().iClodeFeeDetailsTabandChooseManageFeeplanTab();
	}

	@And("I select the created exam fee plan for apply")
	public void iSelectExamFeePlanforApply() throws Exception {
		new FeeandPaymentPages().iSelectExamFeePlanforApply();
