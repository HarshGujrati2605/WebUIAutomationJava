...
public class GradeProgramPage extends GlobalVariable {
	...
	By additonalreqYes = By.xpath("//label[contains(text() , 'Additional Requirement:')]/../parent::td/div[contains(@class , 'box')]//label[text() = 'Yes']/../input");
	...
	By placementperiodnobtn = By.xpath("//table[@data-xpath = 'radiogroup_whetherPlacementPeriod_radiofield']//label[text() = 'No']/../input");
	By periodstatudpdwarrow = By.xpath("//div[@name='periodStatus']/../../td[3]");
	By periodstatuvalue = By.xpath("//div[@data-xpath='multiselectcombofield_boundlist']/div/span");
...
//		CommonActions.clickOnElementAndType(minCGPA, "2", "min CGPA");
		...
		try {
			...
			Thread.sleep(4000);
			CommonActions.iClickElementByLocator(By.xpath("//div[text() = ' " + assigncalender + " ']"),"Assign Calendername");
...
//		CommonActions.clickOnElementAndType(periodenddate, CommonActions.getTodayDate("2024"), "Last date");
		...
		Thread.sleep(3000);	
		CommonActions.iClickElementByLocator(By.xpath("//div[contains(text(),'"+replacestr+"')]"), "Selecting the offered academy location ");
