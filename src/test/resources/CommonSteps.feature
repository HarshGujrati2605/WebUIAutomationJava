Feature: Common feature
  ...
  Scenario Outline: Common steps
    ...
    Examples: 
      | button                    | Modulename      | Action                  | type                     | Buttonname          | rownumber | name            |Header|
      | Delete , Add, View , Edit | Manage Campaign | Add, Delete, View, Edit | normal , nested , window | Today , More Action |     1,2,3 | any header name |Any top header|
