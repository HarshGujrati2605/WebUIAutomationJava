...
Feature: Create Admission features
  ...
  #| Fees & Payments |                     Manage Bills             | Student      |Student     |
  ...
  ###########################  Student Course Enrollment in Program and courses ##############################
  Scenario Outline: Student Course Enrollment in P&C
    Given I click on "<Module>"
    And I click on "<Modulename>" Module
    And I search for student emrolled program in course section
    And I select the enrolled course and open course enrollment
    Then I refresh page

    Examples: 
      | Module             | Modulename                |
      | Programs & Courses | Student Course Enrollment |
